...
export const ComponenteTres = () => {
  ...
  return (
    <div className="card-ia" style={{ padding: '30px', textAlign: 'center' }}>
      <h2 style={{ color: '#61dafb' }}>Videos de la IA Generativa: Creatividad Computacional</h2>
      ...
      <div style={styles.mainVideoContainer}>
        <iframe 
          width="100%" 
          height="450" 
          src="https://www.youtube.com/embed/Sqa8Zo2XWc4" // Ejemplo: OpenAI Sora
          title="Sora OpenAI Video"
          frameBorder="0" 
